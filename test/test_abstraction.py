...
class TestHTTPConnection(object):
    def test_h1_kwargs(self):
        c = HTTPConnection(
            ...
            ssl_context=False, timeout=False, proxy_host=False,
            proxy_port=False, proxy_headers=False, other_kwarg=True
        )
    ...
    def test_h2_kwargs(self):
        c = HTTPConnection(
            'test', 443, secure=False, window_manager=True, enable_push=True,
            ssl_context=True, timeout=False, proxy_host=False, proxy_port=False,
